...
class Welcome extends CI_Controller 
{
	...
	public function generate()
	{
		...
		foreach ($query as $key => $row) 
		{
			...
			$this->sheet->getStyle( 'B'.$indice.':B'.($indice + 23) )->applyFromArray( $this->sidebar( '366092' ) );
		...
		////////////////////////////////
		////////////////////////////////
		$this->sheet = $this->phpexcel->createSheet(1);
		...
		foreach ($query as $key => $row) 
		{
			...
			////////////////////////////////
			$this->cell_value_with_merge( 'B'.$indice, $row['cargo_res'], 'B'.$indice.':B'.($indice + 23) );
			$this->sheet->getStyle( 'B'.$indice.':B'.($indice + 23) )->applyFromArray( $this->sidebar( '948A54' ) );
		...
		// SALIDA EXCEL ( Propiedades del archivo excel )
		////////////////////////////////
		$this->sheet->setTitle("ORIENTADOR");
	/*	$this->phpexcel->getProperties()
		->setTitle("INEI - FOTOCHECK")
		->setDescription("Fotocheck");*/
		...
		////////////////////////////////
		////////////////////////////////
		$this->sheet = $this->phpexcel->createSheet(2);
		...
		foreach ($query as $key => $row) 
		{
			...
			////////////////////////////////
			$this->cell_value_with_merge( 'B'.$indice, $row['cargo_res'], 'B'.$indice.':B'.($indice + 23) );
			$this->sheet->getStyle( 'B'.$indice.':B'.($indice + 23) )->applyFromArray( $this->sidebar( '31869B' ) );
